...
interface ExecutiveReportShiftCardProps {
  shift: 'DAY' | 'NIGHT'
  stats: ExecutiveReport['shifts']['DAY'] | ExecutiveReport['shifts']['NIGHT']
}

export function ExecutiveReportShiftCard({
  shift,
  stats,
}: ExecutiveReportShiftCardProps) {
  return (
    <div
      style={{
    ...
    >
      ...
      <div
        style={{ marginTop: '12px', display: 'flex', justifyContent: 'space-around' }}
      >
