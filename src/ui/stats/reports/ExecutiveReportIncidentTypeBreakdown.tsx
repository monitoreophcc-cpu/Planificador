...
interface ExecutiveReportIncidentTypeBreakdownProps {
  data: IncidentTypeStats[]
}

export function ExecutiveReportIncidentTypeBreakdown({
  data,
}: ExecutiveReportIncidentTypeBreakdownProps) {
  return (
    <div
      style={{
          ...
          return (
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                ...
                <span
                  style={{ fontSize: '14px', fontWeight: 700, color: '#b91c1c' }}
                >
                  {item.points} pts
                </span>
              </div>
