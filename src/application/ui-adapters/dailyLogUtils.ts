 ...
 * 
 * Excludes:
 * 1. VACACIONES / LICENCIA - These reduce the planned staff (e.g. 14/14)
...
export const isExpected = (e: DailyLogEntry) => {
    ...
    if (e.logStatus === 'ABSENT') {
        ...
        // Punctual absences (justified or not) stay in the denominator as
        // operational holes the team still had to cover that day.
        return true
    }
