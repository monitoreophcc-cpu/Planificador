...
import DateSelector from '@/components/header/DateSelector';
import DailyHistoryPanel from '@/components/header/DailyHistoryPanel';
import ComparisonPanel from '@/components/header/ComparisonPanel';
import { Toaster } from '@/components/ui/toaster';

const PDFExportButton = dynamic(() => import('@/components/reports/PDFExportButton'), { 
  ssr: false,
  loading: () => <div className="h-10 w-32 bg-slate-50 animate-pulse rounded-xl" />
});

const PerformanceChart = dynamic(() => import('@/components/charts/ShiftPerformanceChart'), { 
  ssr: false,
  loading: () => <div className="h-80 w-full bg-slate-50 animate-pulse rounded-2xl" />
});
const HourlyDistributionChart = dynamic(() => import('@/components/charts/HourlyDistributionChart'), { 
  ssr: false,
  loading: () => <div className="h-80 w-full bg-slate-50 animate-pulse rounded-2xl" />
});
const PlatformTransactionsChart = dynamic(() => import('@/components/charts/PlatformTransactionsChart'), { 
  ssr: false,
  loading: () => <div className="h-80 w-full bg-slate-50 animate-pulse rounded-2xl" />
});
const PlatformSalesChart = dynamic(() => import('@/components/charts/PlatformSalesChart'), { 
  ssr: false,
  loading: () => <div className="h-80 w-full bg-slate-50 animate-pulse rounded-2xl" />
});
const PlatformAovChart = dynamic(() => import('@/components/charts/PlatformAovChart'), { 
  ssr: false,
  loading: () => <div className="h-80 w-full bg-slate-50 animate-pulse rounded-2xl" />
});
const TopBranchesChart = dynamic(() => import('@/components/charts/TopBranchesChart'), { 
  ssr: false,
  loading: () => <div className="h-80 w-full bg-slate-50 animate-pulse rounded-2xl" />
});
const HourlyAbandonmentRateChart = dynamic(() => import('@/components/charts/HourlyAbandonmentRateChart'), { 
  ssr: false,
  loading: () => <div className="h-80 w-full bg-slate-50 animate-pulse rounded-2xl" />
});
const HourlyConversionRateChart = dynamic(() => import('@/components/charts/HourlyConversionRateChart'), { 
  ssr: false,
  loading: () => <div className="h-80 w-full bg-slate-50 animate-pulse rounded-2xl" />
});
const AuditView = dynamic(() => import('@/components/audit/AuditView'), { 
  ssr: false,
